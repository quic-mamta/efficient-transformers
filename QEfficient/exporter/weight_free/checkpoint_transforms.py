        ...
        **kwargs,
        ...
        def _write_layer_stacks(layer_prefix: str, experts_by_idx: Dict[int, Dict[str, str]]) -> Dict[str, str]:
            ...
            for proj_name, output_name in proj_to_output.items():
                ...
                tensors = {
                    f"{layer_prefix}.all_{output_name}_qweight": qweight,
                ...
                _atomic_save(tensors, out / stack_name)
                for key in tensors:
        ...
        n_workers = max_workers if max_workers is not None else min(len(shard_names), _cpu_count() * 2, 128)
        logger.info(
